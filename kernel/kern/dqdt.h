...
#define dqdt_attr_getcluster(attr)

/** Get the selected CPU */
#define dqdt_attr_getcpu(attr)
...
#undef dqdt_attr_getcluster
#define dqdt_attr_getcluster(_attr) ((_attr)->cluster)

#undef dqdt_attr_getcpu
#define dqdt_attr_getcpu(_attr) ((_attr)->cpu)
